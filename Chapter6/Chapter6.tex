...
\begin{itemize}
%The MICO operator, as defined in Definition \ref{def:mico_operator}, utilizes both the reward difference and the independent coupling calculated over transitions. 
